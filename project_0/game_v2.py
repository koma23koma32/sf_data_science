...
def random_predict(number: int = 1) -> int:
    ...
    min_number = 0 # задаем нижнюю границу поиска
    ...
    while True:
        ...
        if number == predict_number:
            ...
            max_number = predict_number # изменяем верхнюю границу поиска
        elif number > predict_number:
            min_number = predict_number # изменяем нижнюю границу поиска
    return count
